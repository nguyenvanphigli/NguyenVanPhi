...
public class Transaction {
    ...
    public boolean processTransaction() {
        ...
        for(TransactionInput i : inputs) {
            i.UTXO = NVP_Blockchain.UTXOs.get(i.transactionOutputId);
        }

        //Kiểm tra giao dịch hợp lệ
        if(getInputsValue() < NVP_Blockchain.minimumTransaction) {
            System.out.println("Đầu vào của giao dịch quá bé: " + getInputsValue());
            System.out.println("Vui lòng nhập số lượng giao dịch lớn hơn " + NVP_Blockchain.minimumTransaction);
            return false;
        }
        ...
        for(TransactionOutput o : outputs) {
            NVP_Blockchain.UTXOs.put(o.id , o);
        }
        ...
        for(TransactionInput i : inputs) {
            ...
            NVP_Blockchain.UTXOs.remove(i.UTXO.id);
        }
